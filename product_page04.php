...
if ($page < 1) {
    header('Location: product_page04.php');
    exit;
};
...
if ($page > $totalPages) {
    header('Location: product_page04.php?page=' . $totalPages);
    exit;
};
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col">供應項目</th>
                        <th scope="col">合約簽訂日</th>
