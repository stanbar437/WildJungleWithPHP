...
if ($page < 1) {
    header('Location: product_page03.php');
    exit;
};
...
if ($page > $totalPages) {
    header('Location: product_page03.php?page=' . $totalPages);
    exit;
};
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col">#</th>
                        <th scope="col">長(公分)</th>
                        <th scope="col">寬(公分)</th>
                        <th scope="col">高(公分)</th>
